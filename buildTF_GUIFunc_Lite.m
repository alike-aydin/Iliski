function [resultStruct]= buildTF_GUIFunc_Lite(fileFrom, pathFrom, fileTo, pathTo,...
    startParams, dt, range, durationTF)
...
% TF computing
clear resultStruct
resultStruct = findTF_Lite(fileFrom, pathFrom, fileTo, pathTo, options, false);
end
