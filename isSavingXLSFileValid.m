function [errMsg] = isSavingXLSFileValid(filePath)
% ISSAVINGXLSFILEVALID Check the validity of a file to save results in.
%
% function [valid] = isSavingXLSFileValid(filePath)
%
